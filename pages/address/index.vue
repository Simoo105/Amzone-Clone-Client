                ...
                <div class="row a-spacing-micro">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 pl-md-0 pb-2" v-for="(address, index) in addresses" :key="address._id">
                    <div class="a-box a-spacing-none normal-desktop-address-tile">
                      ...
                      <!-- Delete Button -->
                      <div v-if="loggedInUser.address" class="edit-address-desktop-link">
                        <nuxt-link :to="`/address/${address._id}`">Edit</nuxt-link>
                        &nbsp; | &nbsp;
                        <span @click="onDeleteAddresss(address._id, index)">Delete</span>
                        &nbsp; | &nbsp;
                        <!-- Set Address as Default -->
                        <span v-if="loggedInUser.address._id == address._id" >Default</span>
                        <span v-else @click="onSetDefault(address._id)">Set as Default</span>
                      </div>
                    </div>
                  </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async onDeleteAddresss(id, index) {
                try {
