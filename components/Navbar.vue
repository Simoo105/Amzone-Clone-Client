                        ...
                        <div class="nav-global-location">
                            <nuxt-link to="/address" class="nav-a nav-a-2">
                                ...
                                <div id="glow-ingress-block">
                                    <span class="nav-line-1" id="glow-ingress-lien1"> Deliver to</span>
                                    <span v-if="isAuthenticated" class="nav-line-2" id="glow-ingress-lien2"> {{loggedInUser.address.country}}</span>
                                </div>
                            </nuxt-link>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                        <div class="nav-tools">
                            ...
                            <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                                ...
                                <span id="nav-cart-count" aria-hidden="true" class="nav-cart-count n&v-cart-0">{{ getCartLength }}</span>
                            </nuxt-link>
                        </div>
                    </div>    
                </div>
