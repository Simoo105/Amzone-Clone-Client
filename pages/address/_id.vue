              ...
              <form>
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <select class="a-select-option" v-model="address.country">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;" v-model="address.fullName"/>
                  </div>
                  <!-- Street Address -->
                  <div class="a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;" v-model="address.city"/>
                  </div>
                  <!-- State -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">State / Province / Region</label>
                    <input type="text" class="a-input-text" style="width: 100%;" v-model="address.state"/>
                  </div>
                  <!-- Zip Code -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Zip Code</label>
                    <input type="text" class="a-input-text" style="width: 100%;" v-model="address.zipCode"/>
                  </div>
                  <!-- Phone Number -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Phone Number</label>
                    <input type="text" class="a-input-text" style="width: 100%;" v-model="address.phoneNumber"/>
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;" placeholder="1234" v-model="address.securityCode"/>
                  </div>
                  <div class="a-spacing-top-medium">
